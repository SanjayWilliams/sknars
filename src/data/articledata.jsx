const articledata = [
    {
        id: 1,
        title:"Message from President V44PAT Patricia",
    ...
    {
        id: 2,
        title:"Message from Secretary V44LW Jessica",
        text:"Welcome!  Welcome here to one of the Social Media Platform of the almost 50 years old St Kitts and Nevis Amateur Radio Scoiety.  This means of communication was created with you in mind as we seek to create a critical link between you (the public) and us (Amateur Radio Operators).   I am so happy that you took the time to visit our platform and I am certain that this visit will not be your last.  There are lots of spaces available within this unique family and we look forward to welcoming you in the not-too-distant future.",
        image:"./secretary.jpg",
        author:"Secretary",
        publishdate:"10 October 2022"
    }
